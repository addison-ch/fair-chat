defmodule TrueChatWeb.Router do
  use TrueChatWeb, :router

  import TrueChatWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {TrueChatWeb.LayoutView, :root}
